...
router.get('/reports/invoice-audit', (req, res) => res.json(R.invoiceContractAudit(effBuilding(req))));
router.get('/reports/audit-center', (req, res) => res.json(R.auditCenter(req.query.asOf, effBuilding(req))));
